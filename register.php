...
<head>
    ...
    <title>ClassesPix | Registrarse</title>
...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($tipo == 'profesor') {
                $stmt = $conn->prepare("INSERT INTO profesores (nombre, email, password) VALUES (?, ?, ?)");
            } else {
            ...
            if ($stmt->execute()) {
                ...
                $error_message = 'Error en la ejecución: ' . htmlspecialchars($stmt->error);
            }
